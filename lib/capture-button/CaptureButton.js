...
export default class CaptureButton extends Component {
  ...
  resetTimer(add = null) {
    var t =
      add == null
        ? this.props.maxTimerDuration / 1000
        : Math.min(30, this.state.timer + Math.ceil(add / 1000))
      ...
      <View style={[styles.captureButtonView, this.props.style]}>
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            this.setState({ longPressIn: !this.state.longPressIn })
          }}
        >
          {this.state.longPressIn ? (
            <Icon name="stop" color={"red"} size={40} />
          ) : null}
        </TouchableOpacity>
        ...
        >
          <Animated.View style={[styles.captureButton, buttonTransform]}>
            <Animated.View
              style={[styles.captureButtonInner, buttonTransform, timerOpacity]}
            ></Animated.View>
          </Animated.View>
        </TouchableWithoutFeedback> */}
      </View>
